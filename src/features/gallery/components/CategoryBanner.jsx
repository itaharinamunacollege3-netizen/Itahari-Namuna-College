  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-20 space-y-4">
        <Link to="/gallery" className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-brand-gold hover:text-brand-gold/80 transition-colors">
        ...
        <p className="font-heading italic text-brand-white/90 text-lg">"{subtitle}"</p>
      </div>
    </div>
  );
}