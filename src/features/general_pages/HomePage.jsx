        ...
        <AnimatedSection>
          <section className="relative w-full h-[85vh] min-h-137.5 flex items-center justify-center bg-brand-dark overflow-hidden">
            ...
            <div className="absolute inset-0 w-full h-full overflow-hidden">
              <video
                // src="https://namunacollege.edu.np/wp-content/themes/namunacollege/assets/intro.mp4"
                src={introVideo}
                autoPlay
                loop
                muted
              ...
              {/* Translucent Dark Mask Overlay for Premium High-Contrast Text Readability */}
              <div className="absolute inset-0 bg-linear-to-b from-brand-dark/70 via-brand-dark/60 to-brand-dark/75 mix-blend-multiply" />
            </div>
