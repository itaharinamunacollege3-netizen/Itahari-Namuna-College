  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <button
        ...
        className={`w-full py-4 rounded-xl cursor-pointer font-bold text-white transition-all duration-400 ease-in-out ${isSubmitting ? 'bg-stone-400 cursor-not-allowed' : 'bg-linear-to-tr from-[#075F6C]/90 via-[#054a55] to-[#0a0a0a]/90 hover:scale-101'}`}
      >
