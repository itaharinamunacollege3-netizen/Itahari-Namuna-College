          ...
          <>
            <DataTable>
              ...
              <DataTableBody>
                {data?.length ? (
                  data.map((row) => (
                    <DataTableRow key={row.id} className="hover:bg-slate-50">
                      <DataTableCell>
                          <p className="font-medium">{row.fullName}</p>
                          <p className="text-xs text-slate-500">{row.email}</p>
                      </DataTableCell>
                      <DataTableCell>{formatProgram(row.programApplied)}</DataTableCell>
                      ...
                      <DataTableCell>
                          <div className="flex items-center gap-2">
                            <Button size="xs" variant="ghost" onClick={() => openDetail(row.id)}>
